...
@section('content')
<div class="container">
    <h1 class="text-center animated-title">Crear Consultorio</h1>

    <form action="{{ route('consultorios.store') }}" method="POST" class="mt-4">
        @csrf
        <div class="form-group">
            <label for="id_consultorio">ID Consultorio</label>
            <input type="number" name="id_consultorio" id="id_consultorio" class="form-control custom-input" required>
        </div>

        <div class="form-group mt-3">
            <label for="ubicacion_consultorio">Ubicación</label>
            <input type="text" name="ubicacion_consultorio" id="ubicacion_consultorio" class="form-control custom-input" required>
        </div>

        <div class="form-group mt-3">
            <label for="capacidad_consultorio">Capacidad</label>
            <input type="number" name="capacidad_consultorio" id="capacidad_consultorio" class="form-control custom-input" required>
        </div>
        ...
        <div class="text-center mt-4">
            <button type="submit" class="btn btn-primary submit-btn">Crear Consultorio</button>
        </div>
    </form>
</div>
